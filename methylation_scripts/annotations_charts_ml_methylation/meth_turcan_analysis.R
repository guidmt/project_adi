...
pdf("turcan_hyper_meth_signals.May.pdf")
...
pdf("PCA_hyper_DMRs_Turcan.May.pdf")
p<-fviz_pca_ind(res.pca,
             col.ind = groups, # color by groups
             palette = c("#00AFBB",  "#FC4E07"),
             legend.title = "Groups",
...
pdf("turcan_hyper_meth_signals_genelevel.May.pdf")
...
pdf("PCA_hyper_DMRs_Turcan_genelevel.May.pdf")
p<-fviz_pca_ind(res.pca,
             col.ind = groups, # color by groups
             palette = c("#00AFBB",  "#FC4E07"),
             legend.title = "Groups",
...
pdf("turcan_hypo_meth_signals.May.pdf")
...
pdf("PCA_hypo_DMRs_Turcan.May.pdf")
p<-fviz_pca_ind(res.pca,
             col.ind = groups, # color by groups
             palette = c("#00AFBB",  "#FC4E07"),
             legend.title = "Groups",
...
pdf("turcan_hypo_meth_signals_genesignal.May.pdf")
...
pdf("PCA_hypo_DMRs_Turcan_genelevel.May.pdf")
p<-fviz_pca_ind(res.pca,
             col.ind = groups, # color by groups
             palette = c("#00AFBB",  "#FC4E07"),
             legend.title = "Groups",
...
#                     upper = ciobj[, 3])
#
#pdf("Turcan_DMRs_data_with_regions_Adi.May.pdf")
