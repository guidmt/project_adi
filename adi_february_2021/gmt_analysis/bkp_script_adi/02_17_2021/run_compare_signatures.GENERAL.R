...
for(i in 1:nrow(sampleinfo)){
	...
	#remove non coding genes from the DEGs list "Gm",[0-9]
	#genes_to_save<-grep(grep(grep(grep(grep(grep(statistics_degs$Gene_name,pattern='Rik',invert=T,value=T),pattern='Gm[0-9]',value=T,invert=T),pattern='AC',invert=T,value=T),pattern='CT',invert=T,value=T),pattern="mt-",invert=T,value=T),pattern="CAA",invert=T,value=T)
	
	# genes_to_save<-grep(grep(grep(grep(grep(grep(grep(grep(grep(statistics_degs$Gene_name,pattern="Rik",invert=T,value=T),pattern="Gm[0-9]",value=T,invert=T),pattern="AC",invert=T,value=T),pattern="CT",invert=T,value=T),pattern="mt-",invert=T,value=T),pattern="CAA",invert=T,value=T),pattern="Snord",value=T,invert=T),pattern="BC",value=T,invert=T),pattern="Scarna",value=T,invert=T)
	
	#get the statistics of DEGs
  ...
  matrix_to_plot_hs_nocombat<-t(input_ge[,-c(which(colnames(input_ge)%in%col_to_select))])
	...
	# par(mar=c(15,3,1,1))
	# boxplot(log(matrix_mm2+1,2),las=2)
	# dev.off()
  ...
  matrix_to_plot_ms <- as.data.frame(matrix_to_plot_ms[, lapply(.SD, mean), by = gs])
	...
	output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".nocombat.png",sep="")
  output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".nocombat.var.png",sep="")
  ...
  annotation_with_scores<-cbind(annotation_all,scores_hs[,-1])
	
  output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".nocombat.withSCORE.png",sep="")
  output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".nocombat.var.withSCORE.png",sep="")
	
  plot_heatmap_hs(matrix_to_plot_hs_nocombat2,annotation_with_scores,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=TRUE,number_clusters_row=2) 
  ...
  annotation_all<-ann3[,c("Samples","type","IDH1_R132H","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters")]
	...
	output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".LGG.nocombat.png",sep="")
  ...
  plot_heatmap_hs(matrix_to_plot_lgg,annotation_all_lgg,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=TRUE,number_clusters_row=2)
  ...
  annotation_with_scores<-cbind(annotation_all_lgg,scores_hs_lgg[,-1])
 
  output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".LGG.nocombat.withSCORE.png",sep="")

  output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".LGG.nocombat.var.withSCORE.png",sep="")
  			                
  plot_heatmap_hs(matrix_to_plot_lgg,annotation_with_scores,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=TRUE,number_clusters_row=2) 
  
  # Heatmap samples IDH1 + TP53 + ATRX with scores 
  annotation_all_compare_genes<-ann3[,c("Samples","type","IDH1_R132H","IDH1_other","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters")]
  ...
  output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".LGG_TRIPLEMUT.nocombat.withSCORE.png",sep="")
  
  output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".LGG_TRIPLEMUT.nocombat.var.withSCORE.png",sep="")
  
  plot_heatmap_hs(matrix_lgg_triple_mut,annotation_lgg_triple_mut_with_scores,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=TRUE,number_clusters_row=2) 
	...
	compareDegsHs_MM(matrix_hs=matrix_to_compare_degs,annotation_for_comp_degs=annotation_all_compare_genes,degs_mouse=ortholog_table_res,lfc=1,pvalue=0.05,output_string=paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".nocombat",sep=""))
	
	}

	mlForModel(matrix_hs=matrix_to_compare_degs,
	           annotation_for_classes=annotation_all_compare_genes,
  ...
  # get only the samples with mutations in IDH1_R132H, TP53, ATRX only LGG
	...
	matrix_to_compare_degs_lgg<-matrix_to_plot_hs_nocombat2[,which(colnames(matrix_to_plot_hs_nocombat2)%in%annotation_all_compare_genes_lgg[,1])]
	matrix_to_compare_degs_lgg<-matrix_to_compare_degs_lgg[,match(annotation_all_compare_genes_lgg[,1],colnames(matrix_to_compare_degs_lgg))]
  ...
  mlForModel(matrix_hs=matrix_to_compare_degs_lgg,
             annotation_for_classes=annotation_all_compare_genes_lgg,
             matrix_all_genes=matrix_to_plot_hs_nocombat[-which(rownames(matrix_to_plot_hs_nocombat)%in%ortholog_table_res[,1]),],
  ...
  #
  # get only the samples with mutation in IDH1_R132H
  #
  ann_r132h<-ann3[,c("Samples","type","IDH1_R132H","IDH1_other","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters")]
  
  #ann_r132h$status2<-rep(NA,nrow(ann_r132h))
  #ann_r132h$status2[-which(ann_r132h$IDH1_R132H==1 & ann_r132h$TP53==0 & ann_r132h$ATRX==0)]<-0
  #ann_r132h$status2[which(ann_r132h$IDH1_R132H==1 & ann_r132h$TP53==0 & ann_r132h$ATRX==0)]<-1
  ann_r132h<-ann_r132h[which(ann_r132h$IDH1_R132H%in%1 & ann_r132h$IDH1_other%in%1),]
  
  matrix_onlyR132H<-matrix_to_plot_hs_nocombat2[,which(colnames(matrix_to_plot_hs_nocombat2)%in%ann_r132h[,1])]
  ...
  annotation_all<-ann3[,c("Samples","type","IDH1_R132H","IDH1_other","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters")]
  ...
  if(directory_exp=="Comp8_C1A_vs_C1B"){
	...
	annotation_mut<-annotation_all[annotation_all$type%in%"LGG" & (annotation_all$IDH1_R132H==1 | annotation_all$IDH1_other==1) & annotation_all$TP53==1 & annotation_all$ATRX==1,]
	annotation_only_idh<-annotation_all[annotation_all$type%in%"LGG" & (annotation_all$IDH1_R132H==1 | annotation_all$IDH1_other==1),]
  ...
  for(an_gs in 1:length(matrices_for_gsva)){
          ...
          print(paste("run cox analysis",thr_cox))
          ...
          output_pdf<- paste(paste("OS",sep="."),samplesc1ac1b,output_string,"coxph_thrcox",thr_cox,"pdf",sep=".")
          ...
          output_os_txt<- paste(paste("OS",sep="."),samplesc1ac1b,output_string,"coxph_thrcox",thr_cox,"txt",sep=".")
          write.table(scores_gsva,file=output_os_txt,sep="\t",row.names=F,quote=F)
  ...
  output_txt2_var<-paste(paste(output_dir,output_degs2,sep="/"))
	...
	output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".",mkcluster,".nocombat.FS.png",sep="")
	output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".",mkcluster,".nocombat.var.FS.png",sep="")

	plot_heatmap_hs(matrix_to_plot_fs,annotation_all,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=FALSE,number_clusters_row=3,how_split=mod2_classification,strong_cluster=T)
	...
	plot_heatmap_hs(matrix_to_plot_fs,ann_check,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=FALSE,number_clusters_row=3,strong_cluster=T)
...
#   plot_heatmap_hs(matrix_to_plot_fs,annotation_with_scores,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in GBM and LGG,no combat",width=10,split=TRUE,km=FALSE,number_clusters_row=3,how_split=mod2_classification,strong_cluster=T)
	...
	annotation_temp<-cbind(annotation_all,mod2_classification)
	annotation_fs_lgg<-annotation_temp[annotation_all$type%in%"LGG",]
	output_hs<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".",mkcluster,".nocombat.FS_LGG.png",sep="")
	output_hs_var<-paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".",mkcluster,".nocombat.var.FS_LGG.png",sep="")

  matrix_to_plot_fs_lgg<-matrix_to_plot_fs[,which(colnames(matrix_to_plot_fs)%in%annotation_fs_lgg[,1])]
	
	plot_heatmap_hs(matrix_to_plot_fs_lgg,annotation_fs_lgg,output_hs=output_hs,output_hs2=output_hs_var,column_title="DEGs mm in LGG,no combat",width=10,split=TRUE,km=FALSE,number_clusters_row=3,how_split=annotation_fs_lgg$mod2_classification,strong_cluster=T)
	...
	annotation_ml<-ann3[,c("Samples","type","IDH1_R132H","IDH1_other","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters")]
	annotation_ml$status2<-rep(NA,nrow(annotation_ml))
	
	annotation_ml$status2[-which((annotation_ml$IDH1_R132H==1 | annotation_ml$IDH1_other==1) & annotation_ml$TP53==1 & annotation_ml$ATRX==1)]<-0
	annotation_ml$status2[which((annotation_ml$IDH1_R132H==1 | annotation_ml$IDH1_other==1) & annotation_ml$TP53==1 & annotation_ml$ATRX==1)]<-1

	input_ml_fs<-matrix_to_plot_fs[,which(colnames(matrix_to_plot_fs)%in%annotation_ml[,1])]
	input_ml_fs<-input_ml_fs[,match(annotation_ml[,1],colnames(input_ml_fs))]
	...
	annotation_ml_lgg<-annotation_ml[annotation_ml$type %in% "LGG",]

	input_ml_fs<-matrix_to_plot_fs[,which(colnames(matrix_to_plot_fs)%in%annotation_ml_lgg[,1])]	
	input_ml_fs<-input_ml_fs[,match(annotation_ml_lgg[,1],colnames(input_ml_fs))]
  ...
  output_xlsx<-paste(paste(output_dir,output_degs,sep="/"))
	...
	#
	ortholog_table_ensembl_cpg<-unique(convertMouseGeneList(genes_cpg_mouse))
	ortholog_table_res<-integrated_conversion_mouse_human(mgi=ortholog_table_mgi_cpg,ensembl=ortholog_table_ensembl_cpg)
	
	CpG_island<-ortholog_table_res[,1]
	  
	sampleinfo_meth<-data.frame(ID=c("genes_degs","genes_degs","genes_degs","feature_selection_genes","CpG_island"),
	           Rdata1=c(paste(directory_exp,pval,lfc,"meth.RData",sep="."),
	           ...
	           output1=c(paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".ge.meth.nocombat.png",sep=""),
	           ...
	           output2=c(paste(paste(directory_exp,"method.fc",pval,lfc,sep="."),".ONLY.METH.nocombat.png",sep=""),
	           ...
	           matrix_to_use=c("matrix_to_plot_hs_nocombat2","matrix_to_plot_lgg","matrix_onlyR132H","matrix_to_plot_fs","matrix_to_plot_fs"),
	           genes_to_use=c("genes_degs","genes_degs","genes_degs","feature_selection_genes","CpG_island"),
	           qthr=c(20,20,20,20,20),stringsAsFactors = F)
	...
	ann_meth<- ann_meth[,c("Samples","type","IDH1_R132H","IDH1_other","TP53","ATRX","PDGFRA","IDH_codel_subtype","chr7_gain_chr_10loss","histology","clusters","IDH_methylation_clusters","Supervised_DNA_methylation_clusters")]
	ann_meth$IDH1_status<-rep(0,nrow(ann_meth))
	ann_meth$IDH1_status[which(ann_meth$IDH1_R132H==1 | ann_meth$IDH1_other==1 & ann_meth$TP53==1 & ann_meth$ATRX==1)]<-1
  ...
  meth_gbm4<-meth_gbm3[meth_gbm3[,6]%in%res_cgi_to_use,]
	...
	if(type_experiment=="feature_selection_genes" | type_experiment=="CpG_island" ){
  ...
  heatmapMouse(matrix_to_plot_ms,output_mm,ann_mm_clean2[,-1])
	...
	setwd("/mnt/data/lab/gmt_data/data_brain/adi_data_november")
